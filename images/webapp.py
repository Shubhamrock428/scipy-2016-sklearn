...
def demo():
    if request.method == 'POST':
        ...
        graph =app.graph
        y_pred = graph.get_tensor_by_name("pridiction:0")
        ...
        #print(pred)
        out={"match":str(result[0][0]),"not match":str(result[0][1])}
        return jsonify(out)
          ...
          <hr />
            <div class="container">
              <div style="margin-top:5%">
		            <h1 style="color:black">Car Classification Demo</h1>
...
app.graph=load_graph('./frozen_inference_graph.pb')  
